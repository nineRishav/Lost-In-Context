...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=f"/DATA1/konda/XAI/XAI-Project/imagenet_9_exp/results/outputs-final-innings/{MODEL_NAME}/paths/A5-correct-imagepaths-among_ALL_VARIANTS.json",
    )
