            ...
            for class_name in classes:
                ...
                try:
                    for img_name in os.listdir(
                        os.path.join(DATA_BASE_PATH, variety, class_name)
                    ):
                    ...
                    continue
                print(f"{class_name} :: all images count : {clas_count}")
                results[method][variety][class_name] = [
                    round(num, 3) for num in class_stats
                ]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_base_path",
        type=str,
        default=f"/DATA1/konda/XAI/data/imagenet-9/activation-maps/activations-{MODEL_NAME}/paper_new",
    )
    parser.add_argument(
        "--output_path",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=f"/DATA1/konda/XAI/XAI-Project/imagenet_9_exp/results/outputs-2nd-innings/{MODEL_NAME}/paths/accuracy-image_paths-wrong-ooc-only_fg.json",
    )
...
"""
Work : Calculates the metric of images which is for all the noise_variants(gaussian + white) of the model, and saves their metric in a json file
