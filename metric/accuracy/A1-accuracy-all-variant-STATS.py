...
arg_parser.add_argument(
    "--data-path",
    default=f"../../data/imagenet-9/data_context_0.3",
...
def main(args: Namespace):
    ...
    output_json_file_path = os.path.join(output_base_path, f"A1-accuracy-all-variant-STATS-nonorm.json")
    output_json_images_file_path = os.path.join(output_base_path, f"paths")
    output_json_images_file_path = os.path.join(
        output_base_path, f"A1-correct-imagepaths-among_all_variants.json"
    )
    ...
    for data_variant in data_variants:
        ...
        class_names = os.listdir(os.path.join(DATA_BASE_PATH, data_variant))
        class_names.sort()
        ...
        for i, class_name in enumerate(class_names):
            ...
            class_path = os.path.join(DATA_BASE_PATH, data_variant, class_name)
...
2. Deactivate Normalization for the resnet50_in9l model ✅
