...
CUDA_VISIBLE_DEVICES=1 python A3-accuracy-9_as_CS-STATS+PATHS.py --arch resnet50
CUDA_VISIBLE_DEVICES=1 python A3-accuracy-9_as_CS-STATS+PATHS.py --arch resnet101
CUDA_VISIBLE_DEVICES=1 python A3-accuracy-9_as_CS-STATS+PATHS.py --arch resnet50_in9l
CUDA_VISIBLE_DEVICES=1 python A3-accuracy-9_as_CS-STATS+PATHS.py --arch efficientnet
CUDA_VISIBLE_DEVICES=1 python A3-accuracy-9_as_CS-STATS+PATHS.py --arch vit_base
