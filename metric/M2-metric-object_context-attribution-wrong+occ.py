...
if __name__ == "__main__":
    MODEL_NAME = "vit_base"
    TYPES = ["wrong-mixed_next", "wrong-mixed_rand", "wrong-mixed_same","wrong-only_fg", "wrong-original"]
...
'''
Work : Calculates the metric of all variant of the model, and saves their metric in a json file
...
6. For Efficientnet, GuidedBackpropReLUModel is missing ⚠️
